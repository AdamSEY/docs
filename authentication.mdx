...
|-----------|-------------|
| `project:read` | View projects and their details |
| `project:write` | Create, update, and delete projects |
| `email:read` | View generated emails and conversations |
| `email:write` | Generate new emails and manage conversations |
| `subscriber:read` | View subscribers and audience segments |
| `subscriber:write` | Add, update, and delete subscribers |
| `export:read` | View export history |
| `export:write` | Trigger email exports |
